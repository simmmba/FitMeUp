...
const GeneralThirdTab = () => {
    ...
    const handleMessageClick = (mid) => {
        axios.get(`${process.env.REACT_APP_URL}/message?mid=` + mid)
            .then(res => {
            ...
            {readMode?(
                <div>
                    ...
                    {replyMode?(
                        <div className="center">
                            ...
                            <div className="selectBtn" onClick={handleSendBtn}>보내기</div>
                        </div>
                    ):(
                        <div className="center">
                            {messageType?(<div className="smallSelectBtn" onClick={handleReplyBtn}>회신</div>):(<div/>)}
                            <div className="smallSelectBtn" onClick={handleBackBtn}>확인</div>
                        </div>
                    )}
                </div>
            ):(
                <div>
                    <div className="messageBox">
                        <div className="center">
                            <div className="smallSelectBtn" onClick={get_received_message}>받은 메시지</div>
                            <div className="smallSelectBtn" onClick={get_sent_message}>보낸 메시지</div>
                        </div>
                        <div>
